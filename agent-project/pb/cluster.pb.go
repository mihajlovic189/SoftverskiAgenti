...
func (x *ClusterPing) GetFrom() string {
	if x != nil {
		return x.From
	}
	return ""
...
func (x *ClusterPong) GetFrom() string {
	if x != nil {
		return x.From
	}
	return ""
...
const file_cluster_proto_rawDesc = "" +
	"\n" +
	"\rcluster.proto\x12\x02pb\"!\n" +
	"\vClusterPing\x12\x12\n" +
	"\x04from\x18\x01 \x01(\tR\x04from\"!\n" +
	"\vClusterPong\x12\x12\n" +
	"\x04from\x18\x01 \x01(\tR\x04fromB\x12Z\x10agent-project/pbb\x06proto3"
...
var file_cluster_proto_goTypes = []any{
	(*ClusterPing)(nil), // 0: pb.ClusterPing
	(*ClusterPong)(nil), // 1: pb.ClusterPong
}
